    ...
    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(1), ['campaigns'])){{ 'bg-slate-900' }}@endif">
        ...
        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(1), ['campaigns'])){{ 'bg-slate-900' }}@endif">
            ...
            <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(1), ['campaigns'])){{ 'bg-slate-900' }}@endif">
                ...
                </div> <x-dropdown-filter align="right" />
                ...
                <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    ...
                    <span class="hidden xs:block ml-2">Add View</span>
                </button> <x-dropdown-filter align="right" />
                ...
                <!-- Card (Income/Expenses) -->
                <x-dashboard.dashboard-card-13 /><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">

                <!-- Filter button --> <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                                                                                                                        ...
                                                                                                                        <!-- Filter button --> <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                                                                                                                            ...
                                                                                                                            <!-- Filter button --> <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                                                                                                                                ...
                                                                                                                                <!-- Filter button --> <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                                                                                                                                    ...
                                                                                                                                    <!-- Filter button -->  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        </div>-->  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        </div>-->  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        </div>-->  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        </div>-->  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        </div>-->  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        ...
        </div>-->v  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        </div>-->  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        </div>-->v  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        </div>-->  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        </div>-->  <!--   @livewire('admin.about-us',['dataFeed'=>$dataFeed])
        ...
        </div>--><td class="p-2 whitespace-nowrap">
                                                                                                                                    ...
                                                                                                                                    </tr> Actions --><!-- Right: Actions --><!-- Right: Actions --><!-- Right: Actions -->
                <x-dashboard.welcome-banner />
                <x-dashboard.welcome-banner />
                <x-dashboard.welcome-banner />
                <x-dashboard.welcome-banner />
