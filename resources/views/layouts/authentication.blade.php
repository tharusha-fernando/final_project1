        ...
        <main class="bg-white">
            ...
            <div class="relative flex">
                    ...
                    <div class="min-h-screen h-full flex flex-col after:flex-1">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                                <!-- Logo -->
                                <a class="block" href="#">
                                    <image src="{{ asset('images/logo.png') }}" width="75" height="75" class="border-2"></image>
                ...
                <div class="hidden md:block absolute top-0 bottom-0 right-0 md:w-1/2" aria-hidden="true">
                    <img class="object-cover object-center w-full h-full" src="{{ asset('images/background.jpg') }}" width="760" height="1024" alt="Authentication image" />
